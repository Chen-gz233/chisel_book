...
object GemminiFPConfigs {
  ...
  val defaultFPConfig = GemminiArrayConfig[Float, Float, Float](
    ...
    inputType = gemmini.Float(8, 24),
    spatialArrayOutputType = gemmini.Float(8, 24),
    accType = gemmini.Float(8, 24),

    mvin_scale_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
    mvin_scale_acc_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
    mvin_scale_shared = false,

    acc_scale_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0",
      c_str = "((x) * (scale))"
    )),
  ...
  val FP32DefaultConfig = defaultFPConfig.copy(inputType = gemmini.Float(8, 24), spatialArrayOutputType = gemmini.Float(8, 24), accType = gemmini.Float(8, 24),
                                               tile_latency = 2,
                                               mvin_scale_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
                                               mvin_scale_acc_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
                                              )
  ...
  val FP16DefaultConfig = defaultFPConfig.copy(inputType = gemmini.Float(5, 11), spatialArrayOutputType = gemmini.Float(5, 11), accType = gemmini.Float(8, 24),
                                               tile_latency = 2,
                                               mvin_scale_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(5, 11), -1, identity = "1.0", c_str="((x) * (scale))")),
                                               mvin_scale_acc_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(5, 11), -1, identity = "1.0", c_str="((x) * (scale))")),
                                              )
  
  //Bfloat16 Brain-half Precision Configuration
  val BF16DefaultConfig = defaultFPConfig.copy(inputType = gemmini.Float(8, 8), spatialArrayOutputType = gemmini.Float(8, 8), accType = gemmini.Float(8, 24),
                                               tile_latency = 2,
                                               mvin_scale_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
                                               mvin_scale_acc_args = Some(ScaleArguments((t: Float, u: Float) => t * u, 4, gemmini.Float(8, 24), -1, identity = "1.0", c_str="((x) * (scale))")),
                                              )
  ...
  val BF16Default8Config = defaultFPConfig.copy(inputType = gemmini.Float(8, 8), spatialArrayOutputType = gemmini.Float(8, 8), accType = gemmini.Float(8, 24),
