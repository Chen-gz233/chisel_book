...
object Mesh extends App{
  ...
  val output_delay = 1
    ...
    emitVerilog(
      new Mesh(inputType, outputType, accType, df, tree_reduction, tile_latency, max_simultaneous_matmuls, output_delay, tileRows, tileColumns, meshRows, meshColumns),
